...
"Ven a Crecer" (which translates to "come to learn") is [Code For Venezuela][C4V]'s project to bring [MIT's ReACT][ReACT] to the Venezuelan diaspora. It's developed with BerserkTech core members, see [/AUTHORS](/AUTHORS) for the full list of people involved, and [our project tracker][GHP] to follow our progress.
...
"Ven a Crecer" is a project that exist due to dire existing circumstances as well as a sum of efforts that happen to be in the right place at the right time. Before elaborating on the project itself, we should mention the surrounding circumstances.

### About Code For Venezuela

As [their website][C4V] says:

> Code for Venezuela is an organization dedicated to bringing together the Venezuelan diaspora, leveraging their tech expertise and network around the world to help advance technology adoption in Venezuela.
> 
> We believe we can tap into the immense human capital of our community and funnel it towards effective initiatives that can bring tremendous value to Venezuela.
> 
> **Mission:**
...
> - Developing Technical Talent in Venezuela.
> Leveraging Technology to Develop the Country.

You can read more about Code For Venezuela [here][C4V].
...
"Ven a Crecer" is an ongoing effort. Here's a list of links related to current existing achievements:

- ["Ven a Crecer" official GitHub Project][GHP]. It includes our upcoming, ongoing and finished tasks.
...
Here is a list of external resources used or relevant to this project:

- ["Ven a Crecer" official GitHub Project][GHP]
- [Code For Venezuela's website][C4V]
- [MIT ReACT's website][ReACT]
